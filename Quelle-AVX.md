...
| similarity       | -         | Streamlined syntax for setting similarity.word & similarity.lemma to the same value<br/>fuzzy phonetics matching threshold is between 33% and 99%<br/>0% or *none* means: do not match on phonetics (use text only)<br/>100% or *exact* means that an *exact* phonetics match is expected | 33% to 99% [fuzzy] **or** ...<br>0% **or** *none*<br>100% **or** *exact* | 0% / none     |
