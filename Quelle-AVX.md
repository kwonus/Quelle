...
| Action      | Syntax                                                       |
| ----------- | ------------------------------------------------------------ |
| **@delete** | #*tag* <u>or</u> #*wildcard* <u>or</u> -macro FROM <u>and/or</u> TO<br/>**FROM parameter :** *from* yyyy/mm/dd **or** *from* yyyy-mm-dd **or** *from* mm/dd/yyyy **or** *from* mm-dd-yyyy<br/>**TO parameter :** *to* yyyy/mm/dd **or** *to* yyyy-mm-dd **or** *to* mm/dd/yyyy **or** *to* mm-dd-yyyy |
| **@view**   | #*tag* <u>or</u> #*wildcard* <u>or</u> -macro FROM <u>and/or</u> TO<br/>**FROM parameter :** *from* yyyy/mm/dd **or** *from* yyyy-mm-dd **or** *from* mm/dd/yyyy **or** *from* mm-dd-yyyy<br/>**TO parameter :** *to* yyyy/mm/dd **or** *to* yyyy-mm-dd **or** *to* mm/dd/yyyy **or** *to* mm-dd-yyyy |
